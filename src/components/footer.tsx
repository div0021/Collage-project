...
const OURADDRESS = [
    ...
    },
    {
        ...
        size:34,
        text: '134 Marigold Lane, Coral \nWay, Miami, Florida,\n33169'
    },
    {
        icon: PiPhoneCall,
        size:24,
        text: 'Call us: 0234-556-4596'
    }
]
    ...
    return (
        ...
        <div className="w-full">
              ...
              <ul className="space-y-1">
                {OURADDRESS.map(({icon:Icon,text,size}, key) => (
                  <Typography key={key} as="li" className="font-normal">
                    
                    <p
                      className="py-1 pr-2 transition-transform hover:scale-105 text-white/50 hover:text-white flex items-center"
                    >
                        <Icon size={size} className="mr-3 text-xl"/>
                      {text}
                    </p>
                  </Typography>
                ))}
        ...
        <div className="flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
          <Typography
            variant="small"
            className="mb-4 text-center font-normal text-light-green-800 md:mb-0"
          >
            &copy; {currentYear} <a className="underline" href="#">Green Market Place</a>. All
            Rights Reserved.
          </Typography>
